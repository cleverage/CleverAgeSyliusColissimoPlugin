...
use CleverAge\SyliusColissimoPlugin\Exception\MissingProductInterSearchArgument;
use CleverAge\SyliusColissimoPlugin\Exception\ProductInterRequestException;
use CleverAge\SyliusColissimoPlugin\Model\Inter\ProductInter;
use CleverAge\SyliusColissimoPlugin\Model\Inter\ProductInterResponse;
...
class ProductInterService extends AbstractService
{
    ...
    public function call(ProductInter $productInter): ProductInterResponse
    {
        return $this->doCall(Request::METHOD_POST, self::URL, $productInter->toArray());
    }
