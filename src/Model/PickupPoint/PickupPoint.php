...
class PickupPoint
{
    ...
    public function __construct(\SimpleXMLElement $data) {
        ...
        $this->data['openings'] = [
            'monday' => $data->horairesOuvertureLundi,
            'tuesday' => $data->horairesOuvertureMardi,
            'wednesday' => $data->horairesOuvertureMercredi,
            'thursday' => $data->horairesOuvertureJeudi,
            'friday' => $data->horairesOuvertureVendredi,
            'saturday' => $data->horairesOuvertureSamedi,
            'sunday' => $data->horairesOuvertureDimanche,
        ];

        $this->data['formattedOpenings'] = [
